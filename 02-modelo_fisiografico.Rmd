...
tabla_tamano_cuencas <- data.frame(
  ...
  Rango_tamaño = c("< 25", "25-250", "250-500", "500-2,500", "2,500-5,000", "> 5,000"))
```
...
Las memorias de cálculo que generan las pendientes Taylor - Shwarz se encuentran en el Ápendice.
