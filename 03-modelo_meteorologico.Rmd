...
```{r,  echo=FALSE, warning=FALSE, comment = ""}
est2164_P3 <- ML_estimation(estaciones_lluviamax24h$X2164, dist="P3")

# Parámetros de ajuste (puedes modificarlos según tu conocimiento del dominio)
shape <- est2164_P3[1]  # Parámetro de forma
scale <- est2164_P3[2]  # Parámetro de escala
thres <- est2164_P3[3]  # Parámetro de umbral

# Calcular la densidad de probabilidad para cada valor en el vector lluvia
est2164_P3_cuantiles <- qgamma3(probabilidad_Tr$Probabilidad_Inversa, shape = shape, scale = scale, thres = thres)

```


```{r, echo=FALSE, warning=FALSE, comment = ""}
est2036_P3 <- ML_estimation(estaciones_lluviamax24h$X2036, dist="P3")

# Parámetros de ajuste (puedes modificarlos según tu conocimiento del dominio)
shape <- est2036_P3[1]  # Parámetro de forma
scale <- est2036_P3[2]  # Parámetro de escala
thres <- est2036_P3[3]  # Parámetro de umbral

# Calcular la densidad de probabilidad para cada valor en el vector lluvia
est2036_P3_cuantiles <- qgamma3(probabilidad_Tr$Probabilidad_Inversa, shape = shape, scale = scale, thres = thres)
```
...
```{r, echo=FALSE, warning=FALSE, comment = ""}
est2077_P3 <- ML_estimation(estaciones_lluviamax24h$X2077, dist="P3")

# Parámetros de ajuste (puedes modificarlos según tu conocimiento del dominio)
shape <- est2077_P3[1]  # Parámetro de forma
scale <- est2077_P3[2]  # Parámetro de escala
thres <- est2077_P3[3]  # Parámetro de umbral

# Calcular la densidad de probabilidad para cada valor en el vector lluvia
est2077_P3_cuantiles <- qgamma3(probabilidad_Tr$Probabilidad_Inversa, shape = shape, scale = scale, thres = thres)
